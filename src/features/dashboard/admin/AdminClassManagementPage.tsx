                        ...
                        {classes.map((cls) => (
                            <div key={cls.id} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className="px-2 py-1 text-[10px] font-bold uppercase tracking-wider rounded-md bg-green-100 text-green-700">
                                        Active
                                    </span>
                                </div>
                                ...
                                <div className="mt-auto space-y-2 pt-4 border-t border-gray-100">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-semibold text-gray-800">{cls.lecturerName || 'TBA'}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-500">Students</span>
                                        <span className="font-semibold text-gray-800">{cls.studentIds?.length || 0} Enrolled</span>
                                    </div>
                                </div>
